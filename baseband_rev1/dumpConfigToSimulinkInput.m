...
simInputs(configInd) = simInputs(configInd).setVariable('RxAGCPartition', RxAGCPartition);
simInputs(configInd) = simInputs(configInd).setVariable('RxTimingRecoveryPartition', RxTimingRecoveryPartition);
